...
class TestList(unittest.TestCase):
    ...
    def test_04(self) -> None:
        ...
        self.assertTrue(compare_files("empty_file_con.txt", "empty_file_sol.txt"))

    def test_05(self) -> None:
        conc = Concordance()
        conc.load_stop_table("stop_words.txt")
        with self.assertRaises(FileNotFoundError):
            conc.load_concordance_table("HAJSDHKUASHDJK.txt")
    ...
    def test_06(self) -> None:
        ...
        self.assertTrue(compare_files("file3_con.txt", "file3_sol.txt"))

    def test_07(self) -> None:
        conc = Concordance()
        with self.assertRaises(FileNotFoundError):
            conc.load_stop_table("HAJSDHKUASHDJK.txt")
